export const translations = {
  "🇲🇾 Bahasa Melayu": {
    ...
    signupTitle: "Daftar Akaun Petani Baharu",
    authSubtitle: "Akses sistem pemantauan plot jitu & visi AI FarmNeura v2",
    tabLogin: "Log Masuk",
    ...
    btnLogin: "Log Masuk ke Sistem",
    btnSignup: "Cipta Akaun Baharu",
    btnLogout: "Log Keluar",
    welcomeUser: "Selamat Datang,",
    authSuccessMsg: "Berjaya log masuk! Memuatkan papan pemuka...",
    signupSuccessMsg: "Akaun berjaya didaftarkan! Memuatkan papan pemuka...",
    ...
    step1Desc: "Ambil gambar guna kamera telefon atau muat naik dari galeri.",
    step2Title: "2. Analisis AI & Sensor",
    step2Desc: "Visi AI mengesan penyakit dan menggabungkan data sensor IoT.",
    step3Title: "3. Syor Tindakan Agronomis",
    step3Desc: "Dapatkan langkah pencegahan segera dan simpan ke log plot.",
    ...
    overviewSubtitle: "Selamat datang ke Pemantauan Plot Pertanian Jitu FarmNeura",

    metricOverallHealth: "Kesihatan Keseluruhan Tanaman:",
    ...
    statusAttention: "⚠️ Penyakit/Tekanan Dikesan - Tindakan Diperlukan",
    statusOverdue: "ℹ️ Gambar Terlewat",
    statusOptimal: "✅ Pertumbuhan Optimum",

    btnTakeAction: "Ambil Tindakan ➔",
    btnScanNow: "📷 Imbas Sekarang",
    btnInspect: "Periksa ➔",
  ...
  "🇬🇧 English": {
    ...
    signupTitle: "Register New Farmer Account",
    authSubtitle: "Access FarmNeura v2 precision plot monitoring & AI vision system",
    tabLogin: "Log In",
    tabSignup: "Sign Up",
    ...
    step1Desc: "Snap a photo using your phone camera or upload from gallery.",
    step2Title: "2. AI & Sensor Analysis",
    step2Desc: "AI vision detects condition and fuses live IoT sensor data.",
    step3Title: "3. Agronomist Intervention",
    ...
    overviewSubtitle: "Welcome to FarmNeura Precision Plot Monitoring",

    metricOverallHealth: "Overall Crop Health:",
    ...
    statusAttention: "⚠️ Disease/Stress Detected - Action Needed",
    statusOverdue: "ℹ️ Photo Overdue",
    statusOptimal: "✅ Optimal Growth",

    btnTakeAction: "Take Action ➔",
    btnScanNow: "📷 Scan Now",
    btnInspect: "Inspect ➔",
